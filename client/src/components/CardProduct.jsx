...
import { calculateDiscountedPrice, formatPrice, getSavedAmount } from "../utils/priceUtils";
...
const CardProduct = ({ product, viewMode = "grid" }) => {
  ...
  const savedAmount = getSavedAmount({ price: originalPrice, discount: discountPercent });
