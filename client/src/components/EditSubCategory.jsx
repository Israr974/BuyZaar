...
import { 
  Upload, XCircle, Save, Camera, Trash2, Loader2, X, Layers,
...
const EditSubCategoryModel = ({ onClose, editData, onSuccess }) => {
  ...
  useEffect(() => {
    if (editData) {
      ...
      const initialSelected = editData.category
        ? editData.category.map((cat) => (typeof cat === "string" ? cat : cat._id))
        : [];
          ...
          <div className="space-y-5">
            ...
            <div className="p-3 rounded-lg bg-primary/5 border border-primary/20">
              <p className="text-xs text-text-muted flex items-center gap-2">
                ...
                Subcategories help organize products for better navigation
              </p>
            </div>
          </div>
        </div>
