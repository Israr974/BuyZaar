...
//         className={`input pl-10 pr-8 py-2 text-sm appearance-none cursor-pointer ${className}`}
//       >
...
//       </div>
//       <ArrowUpDown size={14} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-text-muted pointer-events-none" />
//     </div>
//   );
// };
