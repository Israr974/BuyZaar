...
//           <div className="bg-card rounded-xl border border-border p-5 hover:shadow-md transition">
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <p className="text-text-muted text-sm">Office</p>
...
//                     <button className="w-full btn btn-primary py-2 text-sm flex items-center justify-center gap-2">
//                       <Truck size={14} />
