...
// import { ChevronDown,Link, ChevronUp, Search } from "lucide-react";
...
//               <div className="bg-bg-alt px-6 py-4 border-b border-border">
...
//                         className="w-full px-6 py-4 flex items-center justify-between text-left hover:bg-bg-alt/50 transition-colors"
//                       >
...
//             <div className="w-20 h-20 mx-auto rounded-full bg-bg-alt flex items-center justify-center mb-4">
//               <Search className="w-10 h-10 text-text-muted" />
//             </div>
//             <h3 className="text-xl font-semibold text-text mb-2">No results found</h3>
//             <p className="text-text-muted">Try different keywords or browse all categories</p>
//             <button
...
//         <div className="mt-12 text-center bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl p-8 border border-border">
//           <h3 className="text-xl font-semibold text-text mb-3">Still have questions?</h3>
