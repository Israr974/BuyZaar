      ...
      <div className="relative w-full h-96 md:h-[500px] rounded-2xl overflow-hidden shadow-xl mb-12 group">
        {sliderImages.map((slide, idx) => (
          ...
          >
            ...
            <div
              className="px-6 py-3 rounded-xl text-white text-3xl md:text-5xl font-bold backdrop-blur-md shadow-lg transform transition-transform duration-500 hover:scale-105"
              style={{ backgroundColor: "rgba(40, 69, 149, 0.8)" }}
            >
              {slide.label}
            </div>
          </div>
