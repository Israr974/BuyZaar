...
//             {/* Error Badge */}
//             <div className="inline-flex items-center gap-2 bg-error/10 text-error px-4 py-1.5 rounded-full text-sm font-medium mb-4">
//               <AlertCircle size={14} />
//               Error Code: {errorCode}
//             </div>

//             {/* Error Message */}
//             <div className="bg-bg-alt rounded-xl p-5 border border-border text-left mb-6">
//               <p className="text-text font-medium mb-2">Error Message:</p>
//               <p className="text-text-muted text-sm mb-4">{errorMessage}</p>
              
//               <div className="border-t border-border pt-4 mt-2">
//                 <p className="text-text font-medium mb-2">What happened?</p>
//                 <p className="text-text-muted text-sm">{getErrorDetails()}</p>
//               </div>
...
//               <p className="text-sm text-primary font-medium mb-1">💡 Suggested Fix</p>
//               <p className="text-sm text-text-muted">{getErrorSuggestion()}</p>
//             </div>
...
//                 className="w-full btn btn-secondary py-3 rounded-xl flex items-center justify-center gap-2"
//               >
//                 <CreditCard size={18} />
...
//               <span className="w-1.5 h-1.5 bg-error rounded-full mt-1.5"></span>
...
//             <Lock size={18} className="text-success mt-0.5" />
//             <div>
//               <p className="text-sm font-medium text-success">Secure Transaction</p>
...
//             <a href="tel:+916397378896" className="text-primary hover:underline ml-1">
//               +91 63973 78896
//             </a>
//           </p>
