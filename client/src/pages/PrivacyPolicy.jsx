...
const PrivacyPolicy = () => {
  ...
  // Fixed: Added proper key to each section
  return (
    <div className="min-h-screen bg-bg fade-in">
      <div className="container-narrow px-4 py-12">
        {/* Header */}
        ...
        {/* Last Updated Date - Added missing common section */}
        <div className="bg-card rounded-xl border border-border p-6 mb-8">
        ...
        {/* Privacy Sections - Fixed: Added unique key using id instead of index for better React reconciliation */}
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          {sections.map((section, index) => (
            <div 
