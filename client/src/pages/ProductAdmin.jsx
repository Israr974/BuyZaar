...
//                 <p className="text-base md:text-2xl font-bold gradient-text">{totalProducts.toLocaleString()}</p>
//               </div>
//               <div className="w-7 h-7 md:w-12 md:h-12 rounded-full bg-primary/10 flex items-center justify-center">
//                 <Package className="w-3.5 h-3.5 md:w-6 md:h-6 text-primary" />
//               </div>
//             </div>
//           </div>
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <p className="text-text-muted text-xs md:text-sm">Page</p>
//                 <p className="text-base md:text-2xl font-bold gradient-text">{products.length}</p>
//               </div>
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <p className="text-text-muted text-xs md:text-sm">Value</p>
//                 <p className="text-base md:text-2xl font-bold gradient-text">₹{totalValue.toLocaleString()}</p>
//               </div>
//               <div className="w-7 h-7 md:w-12 md:h-12 rounded-full bg-warning/10 flex items-center justify-center">
//                 <DollarSign className="w-3.5 h-3.5 md:w-6 md:h-6 text-warning" />
//               </div>
//             </div>
//           </div>
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <p className="text-text-muted text-xs md:text-sm">Rating</p>
//                 <p className="text-base md:text-2xl font-bold gradient-text">{averageRating.toFixed(1)}</p>
//               </div>
//               <div className="w-7 h-7 md:w-12 md:h-12 rounded-full bg-accent/10 flex items-center justify-center">
//                 <Star className="w-3.5 h-3.5 md:w-6 md:h-6 text-accent" />
//               </div>
//             </div>
//           </div>
//         </div>
...
//                   <div>
//                     <label className="text-[10px] font-medium text-text mb-1 block">Category</label>
//                     <select
...
//                   <div className="h-28 md:h-48 bg-bg-alt rounded-lg mb-2"></div>
//                   <div className="h-2 bg-bg-alt rounded w-3/4 mb-1"></div>
//                   <div className="h-2 bg-bg-alt rounded w-1/2"></div>
//                 </div>
//               ))}
//             </div>
//           ) : products.length === 0 ? (
//             <div className="flex flex-col items-center justify-center py-10 text-center">
//               <div className="w-12 h-12 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center mb-3">
//                 <Package className="w-6 h-6 md:w-12 md:h-12 text-primary/40" />
//               </div>
...
//                   <div className="relative h-28 md:h-48 overflow-hidden bg-bg-alt">
//                     <img
...
//                         <span className="bg-accent text-white px-1 py-0.5 rounded-full text-[8px] md:text-xs font-bold">
//                           -{product.discount}%
//                         </span>
//                       </div>
//                     )}
...
//                     <h3 className="font-semibold text-text text-xs md:text-sm line-clamp-2 min-h-[32px] md:min-h-[40px]">
//                       {product.name}
//                     </h3>
...
//                         <Star size={8} className="md:w-3 md:h-3 text-accent fill-accent" />
//                         <span className="text-[8px] md:text-xs text-text-muted">
//                           {product.rating?.toFixed(1) || "0.0"}
//                         </span>
//                       </div>
//                     </div>
                    
//                     {/* Stock Status - Icon only on mobile */}
//                     <div className="flex items-center gap-1 mt-1 md:mt-2">
//                       <MdOutlineInventory size={10} className="md:w-3 md:h-3 text-text-muted" />
//                       <span className={`text-[8px] md:text-xs ${product.stock > 0 ? 'text-success' : 'text-error'}`}>
...
//                         className="flex-1 btn btn-secondary py-0.5 rounded text-[8px] md:text-xs flex items-center justify-center gap-0.5"
//                       >
...
//                         className="flex-1 bg-error/10 text-error hover:bg-error hover:text-white py-0.5 rounded text-[8px] md:text-xs flex items-center justify-center gap-0.5 transition-all"
//                       >
...
//                 <div
//                   key={product._id}
//                   className="flex items-center gap-2 p-2 bg-card rounded-lg border border-border hover:shadow-sm transition-all"
//                 >
...
//                     <h3 className="font-semibold text-text text-xs md:text-base truncate">
//                       {product.name}
//                     </h3>
...
//               <div className="text-[10px] md:text-sm text-text-muted">
...
//       <button
//         onClick={() => navigate("/dashboard/uploadproduct")}
//         className="lg:hidden fixed bottom-6 right-6 bg-gradient-primary text-white p-3 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 z-40"
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-3 md:p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-base md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">₹{totalValue.toLocaleString()}</p>
              </div>
