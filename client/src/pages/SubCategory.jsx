...
//             <FolderTree size={16} className="md:w-5 md:h-5 text-primary" />
//           </div>
//           <div>
//             <p className="font-medium text-text text-xs md:text-sm">{row.original.name}</p>
...
//               className="h-10 w-10 md:h-12 md:w-12 rounded-lg object-cover border border-border hover:border-primary transition-all cursor-pointer group-hover:scale-110"
//               onError={(e) => {
...
//             <span
//               key={c._id}
//               className="badge bg-primary/10 text-primary px-1.5 py-0.5 rounded-full text-[10px] md:text-xs"
//             >
//               {c.name}
//             </span>
//           ))}
//           {row.original.category?.length > 2 && (
//             <span className="badge bg-bg-alt text-text-muted px-1.5 py-0.5 rounded-full text-[10px] md:text-xs">
//               +{row.original.category.length - 2}
//             </span>
//           )}
//         </div>
...
//           <span className="inline-flex items-center gap-1 px-1.5 py-0.5 md:px-2 md:py-1 rounded-lg bg-primary/5 text-primary font-medium text-[10px] md:text-sm">
...
//             }}
//             className="p-1 md:p-1.5 rounded-lg bg-primary/10 text-primary hover:bg-primary hover:text-white transition"
//             title="Edit"
//           >
...
//               setEditData(row.original);
//             }}
//             className="p-1 md:p-1.5 rounded-lg bg-error/10 text-error hover:bg-error hover:text-white transition"
//             title="Delete"
//           >
...
//                 <p className="text-base md:text-2xl font-bold gradient-text">{data.length}</p>
//               </div>
//               <div className="w-7 h-7 md:w-12 md:h-12 rounded-full bg-primary/10 flex items-center justify-center">
//                 <FolderTree className="w-3.5 h-3.5 md:w-6 md:h-6 text-primary" />
//               </div>
//             </div>
//           </div>
...
//                 <p className="text-base md:text-2xl font-bold gradient-text">{uniqueCategories.length}</p>
//               </div>
//               <div className="w-7 h-7 md:w-12 md:h-12 rounded-full bg-accent/10 flex items-center justify-center">
//                 <Layers className="w-3.5 h-3.5 md:w-6 md:h-6 text-accent" />
//               </div>
//             </div>
//           </div>
...
//                 <p className="text-base md:text-2xl font-bold gradient-text">
...
//                 <Package className="w-3.5 h-3.5 md:w-6 md:h-6 text-success" />
//               </div>
//             </div>
//           </div>
...
//                 <AlertCircle className="w-3.5 h-3.5 md:w-6 md:h-6 text-warning" />
//               </div>
//             </div>
//           </div>
//         </div>
...
//                 <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-text-muted" size={14} className="md:w-4 md:h-4" />
//                 <input
//                   type="text"
//                   placeholder="Search sub-categories..."
//                   value={searchTerm}
//                   onChange={(e) => setSearchTerm(e.target.value)}
//                   className="w-full pl-9 pr-3 py-1.5 md:py-2 rounded-lg border border-border bg-card text-text text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
//                 />
//               </div>
...
//                   className={`btn-outline px-2 py-1.5 md:px-3 md:py-2 rounded-lg flex items-center gap-1 text-xs md:text-sm ${
...
//                   className="btn-primary px-2 py-1.5 md:px-3 md:py-2 rounded-lg flex items-center gap-1 text-xs md:text-sm"
//                 >
//                   <PlusCircle size={14} />
...
//                   <div>
//                     <label className="text-xs font-medium text-text mb-1 block">Products Count</label>
...
//                 <span className="text-[10px] md:text-xs text-text-muted">Active:</span>
//                 {searchTerm && (
//                   <span className="bg-primary/10 text-primary px-1.5 py-0.5 text-[10px] rounded-full flex items-center gap-1">
...
//                   <span className="bg-primary/10 text-primary px-1.5 py-0.5 text-[10px] rounded-full">
...
//                   </span>
//                 )}
//                 <button onClick={clearFilters} className="text-[10px] md:text-xs text-primary hover:underline ml-1">
//                   Clear all
//                 </button>
//               </div>
//             )}
...
//               <button
//                 onClick={() => setOpenSubCategory(true)}
//                 className="btn-primary px-3 py-1.5 md:px-4 md:py-2 rounded-lg flex items-center gap-1 text-sm"
//               >
//                 <PlusCircle size={14} />
//                 Add Sub-Category
//               </button>
