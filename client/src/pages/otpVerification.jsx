                ...
                <div className="flex gap-2 justify-center">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      onChange={(e) => handleOtpChange(index, e.target.value)}
                      onKeyDown={(e) => handleKeyDown(index, e)}
                      className="w-12 h-12 text-center text-xl font-bold rounded-lg border border-gray-200 bg-gray-50 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 outline-none transition-all"
                      maxLength={1}
                      disabled={loading}
                    />
                  ))}
